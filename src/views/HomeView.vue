        ...
        <Transition name="slide" mode="out-in">
          <div :key="step" class="w-full">
            ...
            <section v-else-if="step === 1" class="mx-auto max-w-4xl text-center">
              <div class="glass-card relative min-h-[31rem] overflow-hidden rounded-[2.5rem] p-8 sm:p-12">
                <div
                  ...
                  :key="burst.id"
                  class="pointer-events-none absolute text-5xl"
            ...
            <section v-else-if="step === 2" class="mx-auto max-w-5xl">
              <SlideHeader title="When Are You Free?" subtitle="Pick the date and time that feels most magical." icon="📅" />
              ...
              <div class="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <DateCard
                  ...
                  :key="date.id"
                  :label="date.label"
                  :selected="state.date?.id === date.id"
                  @select="state.date = date"
                />
              </div>
              ...
              <div class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <DateCard
                  ...
                  :key="time.id"
                  helper="A cozy candidate"
                  icon="⏰"
                  :label="time.label"
                  :selected="state.time?.id === time.id"
                  @select="state.time = time"
                />
              </div>
            ...
            <section v-else-if="step === 3" class="mx-auto max-w-6xl">
              ...
              <div class="mt-7 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                <FoodCard
                  ...
                  :key="food.id"
                  :food="food"
                  :selected="state.food?.id === food.id"
